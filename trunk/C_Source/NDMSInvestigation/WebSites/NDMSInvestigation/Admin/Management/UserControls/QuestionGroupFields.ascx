...
<asp:FormView ID="FormView1" runat="server">
    <ItemTemplate>
        <table border="0" cellpadding="3" cellspacing="1">
            ...
            <tr>
                <td class="literal">
                    <asp:Label ID="lbldataGroupName" runat="server" Text="Group Name:" AssociatedControlID="dataGroupName" />
                </td>
                <td>
                    <asp:TextBox runat="server" ID="dataGroupName" Text='<%# Bind("GroupName") %>' TextMode="MultiLine"
                        Width="250px" Rows="5"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="literal">
                    <asp:Label ID="lbldataGroupDescription" runat="server" Text="Group Description:"
                        AssociatedControlID="dataGroupDescription" />
                </td>
                <td>
                    <asp:TextBox runat="server" ID="dataGroupDescription" Text='<%# Bind("GroupDescription") %>'
