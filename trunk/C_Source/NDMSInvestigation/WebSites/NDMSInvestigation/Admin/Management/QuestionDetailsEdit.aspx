<%@ Page Language="C#" Theme="Default" MasterPageFile="~/Shared/DefaultMaster.master"
    AutoEventWireup="true" Inherits="QuestionDetailsEdit" Title="QuestionDetails Edit"
    CodeBehind="QuestionDetailsEdit.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="DefaultContent" runat="Server">
    ...
    <data:QuestionDetailsDataSource ID="QuestionDetailsDataSource" runat="server" SelectMethod="GetByQuestionId">
        <Parameters>
    ...
    <data:EntityGridView ID="GridViewQuestionAnswer1" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <data:HyperLinkField HeaderText="Question Id" DataNavigateUrlFormatString="QuestionDetailsEdit.aspx?QuestionId={0}"
                DataNavigateUrlFields="QuestionId" DataContainer="QuestionIdSource" DataTextField="QuestionContent" />
