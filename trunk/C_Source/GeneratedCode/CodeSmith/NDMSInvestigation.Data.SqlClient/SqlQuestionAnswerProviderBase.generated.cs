...
/*
	...
	Important: Do not modify this file. Edit the file SqlQuestionAnswerProvider.cs instead.
*/
...
namespace NDMSInvestigation.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlQuestionAnswerProviderBase : QuestionAnswerProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlQuestionAnswerProviderBase"/> instance.
		/// </summary>
		public SqlQuestionAnswerProviderBase()
		{
		}
	...
	public SqlQuestionAnswerProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override TList<QuestionAnswer> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@UpdatedBy", DbType.String, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("mark ") || clause.Trim().StartsWith("mark="))
				{
					database.SetParameterValue(commandWrapper, "@Mark", 
			...
			//Create Collection
			TList<QuestionAnswer> rows = new TList<QuestionAnswer>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of NDMSInvestigation.Entities.QuestionAnswer objects.</returns>
		public override TList<QuestionAnswer> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		public override TList<QuestionAnswer> GetByAnswerId(TransactionManager transactionManager, System.Int32 _answerId, int start, int pageLength, out int count)
		{
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByAnswerId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByAnswerId", rows)); 
			}
			finally
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<NDMSInvestigation.Entities.QuestionAnswer> entities)
		{
			...
			DataColumn col1 = dataTable.Columns.Add("AnswerId", typeof(System.Int32));
