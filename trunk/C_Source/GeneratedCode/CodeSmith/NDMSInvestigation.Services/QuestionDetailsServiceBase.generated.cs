...
{		
	...
	/// All custom implementations should be done in the <see cref="QuestionDetails"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class QuestionDetailsServiceBase : ServiceBase<QuestionDetails, QuestionDetailsKey>
	{
		...
		///</summary>
		public QuestionDetailsServiceBase() : base()
		{
		}
		...
		#region Fields
		private static SecurityContext<QuestionDetails> securityContext = new SecurityContext<QuestionDetails>();
		...
		///</summary>
		public static SecurityContext<QuestionDetails> SecurityContext
		{
			get
			{
		...
		/// <summary>
		/// 	public virtual method that Gets rows in a <see cref="TList{QuestionDetails}" /> from the datasource based on the FK_QuestionDetails_QuestionGroup key.
		...
		public virtual TList<QuestionDetails> GetByGroupId(System.Int32 _groupId)
		{
            ...
            {					
				...
				list = new TList<QuestionDetails>(dataProvider.QuestionDetailsProvider.GetByGroupId(transactionManager, _groupId));
			}
            catch (Exception exc)
            {
		...
		public virtual TList<QuestionDetails> GetByGroupId(System.Int32 _groupId, int start, int pageLength, out int totalCount)
		{
            ...
            {					
				...
				list = new TList<QuestionDetails>(dataProvider.QuestionDetailsProvider.GetByGroupId(transactionManager, _groupId, start, pageLength, out totalCount));
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public override QuestionDetails Get(QuestionDetailsKey key)
		{
		...
		/// <returns>Returns an instance of the <see cref="QuestionDetails"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual QuestionDetails GetByQuestionId(System.Int32 _questionId)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				entity = dataProvider.QuestionDetailsProvider.GetByQuestionId(transactionManager, _questionId)   as QuestionDetails;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns an instance of the <see cref="QuestionDetails"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual QuestionDetails GetByQuestionId(System.Int32 _questionId, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByQuestionId");
            ...
            {	
				...
				entity = dataProvider.QuestionDetailsProvider.GetByQuestionId(transactionManager, _questionId, start, pageLength, out totalCount)   as QuestionDetails;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="QuestionDetails" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<QuestionDetails> GetAll() 
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.QuestionDetailsProvider.GetAll(transactionManager);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="QuestionDetails" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{QuestionDetails}"/> </returns>
		public virtual TList<QuestionDetails> GetAll(int start, int pageLength, out int totalCount) 
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
            ...
            {	
				...
				list = dataProvider.QuestionDetailsProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{QuestionDetails}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>QuestionDetails</c> objects.</returns>
		public virtual TList<QuestionDetails> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>QuestionDetails</c> objects.</returns>
		public virtual TList<QuestionDetails> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{QuestionDetails}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>QuestionDetails</c> objects.</returns>
		public override TList<QuestionDetails> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.QuestionDetailsProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<QuestionDetails> Find(string whereClause)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.QuestionDetailsProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<QuestionDetails> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.QuestionDetailsProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>QuestionDetails</c> objects.</returns>
		public virtual TList<QuestionDetails> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>QuestionDetails</c> objects.</returns>
        public virtual TList<QuestionDetails> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>QuestionDetails</c> objects.</returns>
		public virtual TList<QuestionDetails> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.QuestionDetailsProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>QuestionDetails</c> objects.</returns>
        public virtual TList<QuestionDetails> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>QuestionDetails</c> objects.</returns>
		public virtual TList<QuestionDetails> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.QuestionDetailsProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override bool Insert(QuestionDetails entity)
		{
            ...
            {	
				...
				result = dataProvider.QuestionDetailsProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Inserts rows in <see cref="TList{QuestionDetails}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>QuestionDetails</c> objects in a <see cref="TList{QuestionDetails}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<QuestionDetails> Insert(TList<QuestionDetails> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<QuestionDetails>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.QuestionDetailsProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(QuestionDetails entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.QuestionDetailsProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Updates rows in <see cref="TList{QuestionDetails}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>QuestionDetails</c> objects in a <see cref="TList{QuestionDetails}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<QuestionDetails> Update(TList<QuestionDetails> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<QuestionDetails>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.QuestionDetailsProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override QuestionDetails Save(QuestionDetails entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				dataProvider.QuestionDetailsProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Saves rows in <see cref="TList{QuestionDetails}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>QuestionDetails</c> objects in a <see cref="TList{QuestionDetails}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<QuestionDetails> Save(TList<QuestionDetails> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<QuestionDetails>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.QuestionDetailsProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(QuestionDetails entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.QuestionDetailsProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Deletes rows in <see cref="TList{QuestionDetails}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>QuestionDetails</c> objects in a <see cref="TList{QuestionDetails}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<QuestionDetails> Delete(TList<QuestionDetails> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<QuestionDetails>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.QuestionDetailsProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(QuestionDetailsKey key)
		{
		...
		public virtual bool Delete(System.Int32 _questionId)
		{
			...
			try
            {
				...
				result = dataProvider.QuestionDetailsProvider.Delete(transactionManager, _questionId);
		...
		/// <returns>Returns an instance of the <see cref="QuestionDetails"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual QuestionDetails DeepLoadByQuestionId(System.Int32 _questionId, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByQuestionId");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			QuestionDetails entity = GetByQuestionId(_questionId);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(QuestionDetails)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(QuestionDetails entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(QuestionDetails entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="QuestionDetails"/> object to load.</param>
		...
		/// <param name="childTypes">QuestionDetails Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(QuestionDetails entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.QuestionDetailsProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{QuestionDetails}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(QuestionDetails)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{QuestionDetails}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<QuestionDetails> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{QuestionDetails}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(QuestionDetails)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<QuestionDetails> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{QuestionDetails}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{QuestionDetails}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="QuestionDetails"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<QuestionDetails> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			...
			try
            {
				...
				dataProvider.QuestionDetailsProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="QuestionDetails"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">QuestionDetails Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(QuestionDetails entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(QuestionDetails entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.QuestionDetailsProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{QuestionDetails}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{QuestionDetails} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<QuestionDetails> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{QuestionDetails}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{QuestionDetails}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">QuestionDetails Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<QuestionDetails> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{	
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				result = dataProvider.QuestionDetailsProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
