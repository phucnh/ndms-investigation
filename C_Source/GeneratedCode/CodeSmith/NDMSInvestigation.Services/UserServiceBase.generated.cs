...
{		
	...
	public partial class UserServiceBase : ServiceBase<User, UserKey>
	{
		...
		public static User CreateUser(System.Guid _userId, System.String _companyName, System.String _phone, System.String _fax, System.String _email, System.String _address, System.Int32? _employeeNumber, System.String _director, System.String _country, System.String _city, System.String _district)
		{
			User newEntityUser = new User();
			newEntityUser.UserId  = _userId;
			newEntityUser.CompanyName  = _companyName;
			newEntityUser.Phone  = _phone;
			newEntityUser.Fax  = _fax;
			newEntityUser.Email  = _email;
			newEntityUser.Address  = _address;
			newEntityUser.EmployeeNumber  = _employeeNumber;
			newEntityUser.Director  = _director;
			newEntityUser.Country  = _country;
			newEntityUser.City  = _city;
			newEntityUser.District  = _district;
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual User GetByUserId(System.Guid _userId)
		{
            ...
            {	
				...
				entity = dataProvider.UserProvider.GetByUserId(transactionManager, _userId)   as User;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="User"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual User GetByUserId(System.Guid _userId, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByUserId");
		...
		public override TList<User> GetAll() 
		{
            ...
            {	
				...
				list = dataProvider.UserProvider.GetAll(transactionManager);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<User> Find(string whereClause)
		{
            ...
            {	
				...
				list = dataProvider.UserProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>User</c> objects.</returns>
        public virtual TList<User> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		public virtual TList<User> Find(IFilterParameterCollection parameters, string orderBy)
		{
            ...
            {	
				...
				list = dataProvider.UserProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>User</c> objects.</returns>
        public virtual TList<User> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		public virtual TList<User> Insert(TList<User> entityCollection)
		{
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<User>(entityCollection));
			}
			#endregion Security and validation check
		...
		public virtual TList<User> Update(TList<User> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<User>(entityCollection));
			}
			#endregion Security and validation check
		...
		public virtual TList<User> Save(TList<User> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<User>(entityCollection));
			}
			#endregion Security and validation check
		...
		public virtual TList<User> Delete(TList<User> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<User>(entityCollection));
			}
			#endregion Security and validation check
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual User DeepLoadByUserId(System.Guid _userId, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
