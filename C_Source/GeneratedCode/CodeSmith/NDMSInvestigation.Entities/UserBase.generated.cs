...
namespace NDMSInvestigation.Entities
{
	...
	{		
		...
		public UserBase(System.Guid _userId, System.String _companyName, System.String _phone, 
			System.String _fax, System.String _email, System.String _address, System.Int32? _employeeNumber, System.String _director, 
			System.String _country, System.String _city, System.String _district)
		{
			this.entityData = new UserEntityData();
			this.backupData = null;
		...
		///<param name="_city"></param>
		///<param name="_district"></param>
		public static User CreateUser(System.Guid _userId, System.String _companyName, System.String _phone, 
			System.String _fax, System.String _email, System.String _address, System.Int32? _employeeNumber, System.String _director, 
			System.String _country, System.String _city, System.String _district)
		{
			User newUser = new User();
			newUser.UserId = _userId;
			newUser.CompanyName = _companyName;
			newUser.Phone = _phone;
			newUser.Fax = _fax;
			newUser.Email = _email;
			newUser.Address = _address;
			newUser.EmployeeNumber = _employeeNumber;
			newUser.Director = _director;
		...
		[StringLengthValidator(256, MessageTemplate="Maximum length has been exceeded.", Tag="CompanyName")]
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		...
		public virtual System.String CompanyName
		{
			...
			set
			{
				...
				OnColumnChanging(UserColumn.CompanyName, this.entityData.CompanyName);
				this.entityData.CompanyName = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserColumn.CompanyName, this.entityData.CompanyName);
		...
		[StringLengthValidator(32, MessageTemplate="Maximum length has been exceeded.", Tag="Phone")]
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		...
		[StringLengthValidator(32, MessageTemplate="Maximum length has been exceeded.", Tag="Fax")]
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true, 32)]
		public virtual System.String Fax
		{
			...
			set
			{
				...
				OnColumnChanging(UserColumn.Fax, this.entityData.Fax);
				this.entityData.Fax = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserColumn.Fax, this.entityData.Fax);
		...
		[StringLengthValidator(512, MessageTemplate="Maximum length has been exceeded.", Tag="Address")]
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		...
		public virtual System.String Address
		{
			...
			set
			{
				...
				OnColumnChanging(UserColumn.Address, this.entityData.Address);
				this.entityData.Address = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserColumn.Address, this.entityData.Address);
		...
		public virtual System.Int32? EmployeeNumber
		{
			...
			set
			{
				...
				OnColumnChanging(UserColumn.EmployeeNumber, this.entityData.EmployeeNumber);
				this.entityData.EmployeeNumber = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserColumn.EmployeeNumber, this.entityData.EmployeeNumber);
		...
		[StringLengthValidator(512, MessageTemplate="Maximum length has been exceeded.", Tag="Director")]
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true, 512)]
		public virtual System.String Director
		{
			...
			set
			{
				...
				OnColumnChanging(UserColumn.Director, this.entityData.Director);
				this.entityData.Director = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserColumn.Director, this.entityData.Director);
		...
		[StringLengthValidator(512, MessageTemplate="Maximum length has been exceeded.", Tag="Country")]
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true, 512)]
		...
		[StringLengthValidator(512, MessageTemplate="Maximum length has been exceeded.", Tag="City")]
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true, 512)]
		...
		[StringLengthValidator(512, MessageTemplate="Maximum length has been exceeded.", Tag="District")]
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true, 512)]
		public virtual System.String District
		{
			...
			set
			{
				...
				OnColumnChanging(UserColumn.District, this.entityData.District);
				this.entityData.District = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserColumn.District, this.entityData.District);
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"UserId", "CompanyName", "Phone", "Fax", "Email", "Address", "EmployeeNumber", "Director", "Country", "City", "District"};
			}
		}
		#endregion 
...
/*
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{12}{11}- UserId: {0}{11}- CompanyName: {1}{11}- Phone: {2}{11}- Fax: {3}{11}- Email: {4}{11}- Address: {5}{11}- EmployeeNumber: {6}{11}- Director: {7}{11}- Country: {8}{11}- City: {9}{11}- District: {10}{11}{13}", 
				this.UserId,
	...
	public class UserKey : EntityKeyBase
	{
		...
		/// Initializes a new instance of the UserKey class.
		/// </summary>
		public UserKey(System.Guid _userId)
		{
			#region Init Properties
	...
	public enum UserColumn : int
	{
		...
		[ColumnEnum("CompanyName", typeof(System.String), System.Data.DbType.String, false, false, true, 256)]
		CompanyName = 2,
		/// <summary>
		/// Phone : 
		/// </summary>
		[EnumTextValue("Phone")]
		[ColumnEnum("Phone", typeof(System.String), System.Data.DbType.String, false, false, true, 32)]
		Phone = 3,
		/// <summary>
		/// Fax : 
		/// </summary>
		[EnumTextValue("Fax")]
		[ColumnEnum("Fax", typeof(System.String), System.Data.DbType.String, false, false, true, 32)]
		Fax = 4,
		/// <summary>
		/// Email : 
		/// </summary>
		...
		[ColumnEnum("Address", typeof(System.String), System.Data.DbType.String, false, false, true, 512)]
		Address = 6,
		/// <summary>
		/// EmployeeNumber : 
		/// </summary>
		...
		[ColumnEnum("Director", typeof(System.String), System.Data.DbType.String, false, false, true, 512)]
		Director = 8,
		/// <summary>
		/// Country : 
		/// </summary>
		[EnumTextValue("Country")]
		[ColumnEnum("Country", typeof(System.String), System.Data.DbType.String, false, false, true, 512)]
		Country = 9,
		/// <summary>
		/// City : 
		/// </summary>
		[EnumTextValue("City")]
		[ColumnEnum("City", typeof(System.String), System.Data.DbType.String, false, false, true, 512)]
		City = 10,
		/// <summary>
		/// District : 
		/// </summary>
		[EnumTextValue("District")]
		[ColumnEnum("District", typeof(System.String), System.Data.DbType.String, false, false, true, 512)]
		District = 11
	}//End enum
