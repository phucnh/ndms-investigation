...
namespace NDMSInvestigation.Entities
{
	...
	public abstract partial class EntityBaseCore : IEntity, INotifyPropertyChanged, IDataErrorInfo, IDeserializationCallback
	{
		...
		public string Error
		{
			get 
			{
				...
				if (!IsValid)
				{
					...
					{
						errorBuilder.AppendLine(result.Key);
						errorBuilder.AppendLine(result.Message);
					}
				}				
		...
		///<summary>
		///<see cref="Microsoft.Practices.EnterpriseLibrary.Validation.Validator"/> associated with this object.
		///</summary>
		[XmlIgnoreAttribute()]
		protected Validator Validator
		{
			get
			{
				if(_validator == null)
				{
					_validator = ValidationFactory.CreateValidator(this.GetType());
				}
				return _validator;
			}
		}
		...
		/// </summary>
		/// <returns><see cref="Microsoft.Practices.EnterpriseLibrary.Validation.ValidationResults" /></returns>
		[XmlIgnoreAttribute()]
