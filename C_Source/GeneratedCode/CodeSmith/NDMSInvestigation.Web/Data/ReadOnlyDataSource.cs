...
namespace NDMSInvestigation.Web.Data
{
	...
	public abstract class ReadOnlyDataSource<Entity> : BaseDataSource<Entity, Object> where Entity : new()
	{
		...
		public ReadOnlyDataSourceSelectMethod SelectMethod
		{
			get
			{
				ReadOnlyDataSourceSelectMethod selectMethod = ReadOnlyDataSourceSelectMethod.GetAll;
		...
		protected override IList<Entity> GetSelectData(out int count)
		{
			...
			switch ( SelectMethod )
			{
				...
				case ReadOnlyDataSourceSelectMethod.GetAll:
					...
					break;
				case ReadOnlyDataSourceSelectMethod.Find:
					entityList = Provider.Find(FilterParameters, OrderBy, StartIndex, PageSize, out count);
					break;
				default:
					break;
			}
	...
	public enum ReadOnlyDataSourceSelectMethod
	{
		...
		GetAll,
		/// <summary>
		/// Represents the IEntityViewProvider&lt;Entity&gt;.Find method.
		/// </summary>
		Find
	}
