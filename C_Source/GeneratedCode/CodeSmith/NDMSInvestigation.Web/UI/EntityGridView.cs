...
namespace NDMSInvestigation.Web.UI
{
    ...
    public class EntityGridView : GridView
    {
        ...
        private string _exportToolTip = string.Empty;
        ...
        public string ShowPageText
        {
            get
            {
                ...
                return (o != null ? (string)o : "Show Page");
            }
            set
            {
        ...
        public string TotalRecordsText
        {
            get
            {
                ...
                return (o != null ? (string)o : "Total Records");
            }
            set
            {
		...
		/// </summary>
		[
		Description("Whether an empty grid should be shown instead of the EmptyDataTemplate"),
		Category("Misc"),
		DefaultValue("false"),
		]
		public bool ShowGridOnEmptyData
		{
			get
			{
				object o = ViewState["ShowGridOnEmptyData"];
				return (o != null ? (bool)o : false);
			}
			set
			{
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            {
                // handle case when pager section is suppressed
                if (this.PagerSettings != null && this.PagerSettings.Visible)
                {
