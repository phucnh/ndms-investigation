...
namespace NDMSInvestigation.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		public override TList<User> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.User_Find_Dynamic", typeof(UserColumn), filter, orderBy, start, pageLength);
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<NDMSInvestigation.Entities.User> entities)
		{
			...
			DataColumn col2 = dataTable.Columns.Add("Phone", typeof(System.String));
			col2.AllowDBNull = true;		
			DataColumn col3 = dataTable.Columns.Add("Fax", typeof(System.String));
			...
			DataColumn col6 = dataTable.Columns.Add("EmployeeNumber", typeof(System.Int32));
			col6.AllowDBNull = true;		
			DataColumn col7 = dataTable.Columns.Add("Director", typeof(System.String));
			col7.AllowDBNull = true;		
			DataColumn col8 = dataTable.Columns.Add("Country", typeof(System.String));
			col8.AllowDBNull = true;		
			DataColumn col9 = dataTable.Columns.Add("City", typeof(System.String));
			col9.AllowDBNull = true;		
			DataColumn col10 = dataTable.Columns.Add("District", typeof(System.String));
			...
			foreach(NDMSInvestigation.Entities.User entity in entities)
			{
		...
		/// <remarks>
		///		After updating the datasource, the NDMSInvestigation.Entities.User object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
