<%@ Page Language="C#" Theme="Default" MasterPageFile="~/Shared/DefaultMaster.master"
    AutoEventWireup="true" Inherits="QuestionDetails" Title="QuestionDetails List"
...
<asp:Content ID="Content1" ContentPlaceHolderID="DefaultContent" runat="Server">
    ...
    <data:EntityGridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
        DataSourceID="QuestionDetailsDataSource" DataKeyNames="QuestionId" AllowMultiColumnSorting="false"
        DefaultSortColumnName="" DefaultSortDirection="Ascending" ExcelExportFileName="Export_QuestionDetails.xls">
        <Columns>
            ...
            <data:HyperLinkField HeaderText="Group Id" DataNavigateUrlFormatString="QuestionGroupsEdit.aspx?GroupId={0}"
    ...
    <br />
    <asp:Button runat="server" ID="btnQuestionDetails" OnClientClick="javascript:location.href='QuestionDetailsEdit.aspx'; return false;"
        Text="Add New"></asp:Button>
    <data:QuestionDetailsDataSource ID="QuestionDetailsDataSource" runat="server" SelectMethod="GetPaged"
